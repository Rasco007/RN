function inicializarEventos() {
    ...
    $('#btn_limpiar').click(function () {
        ...
        $('#lupa_d_objeto_hecho, #datos_panel, #frm_datos_inmo, #frm_datos_auto').hide();
    ...
    $('#btn_cert_aut').click(function () {
        ...
        if (id) {
            ...
            if (c_exen != 18 && c_exen != 25){
                /*llamar_report('', 'p_id_exencion_obj|' + $('#exenciones_grid').getCell(id, 'id_exencion_obj'), 'PDF');*/
                mostrar_mensaje('Imprimir Certificado','Funcionalidad en construcción.');
            }else{
