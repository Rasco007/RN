...
if ($oper === 'getConsorcio'){
    ...
    SELECT distinct cc.c_organismo, po.d_organismo
	...
	AND (PAC_CANON_RIEGO.FUN_PERMISOS_ABM_DPA(get_info_user('c_usuario'),cr.c_organismo) = 'S'
	    OR
	    PAC_CANON_RIEGO.FUN_TIENE_DPA(get_info_user('c_usuario')) = 0)
	UNION
	SELECT distinct c_organismo, d_organismo
