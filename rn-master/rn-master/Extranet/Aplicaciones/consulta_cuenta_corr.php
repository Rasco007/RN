                    ...
                    <form id='frm_consulta' style="margin-top: 5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input name='n_cuit' id='n_cuit' type='hidden' class='sr-only' value='<?php echo $n_cuit; ?>' readonly/>
                                <input name='n_cuit_mask' id='n_cuit_mask' type='text' value='<?php echo $cuit_mascara; ?>' class='form-control input-sm text-right' readonly/>
                                <input name='id_contribuyente' id='id_contribuyente' value='<?php echo $id_contribuyente; ?>' type='hidden' class='sr-only' readonly/>
                            </div>

                            <div class="form-group col-md-4">
                                <label for="denominacion">Denominaci&oacute;n Contribuyente:</label>
                                <input type="text" class="form-control input-sm mayusculas" id="denominacion" value='<?=$denominacion_contr?>' readonly>
                            </div>

                            <div class="form-group col-md-3">
                                <label for="d_tipo_documento">Tipo Documento:</label>
                                <div class="input-group" id="div_input_tipo_documento">
                                    <input type="text" class="form-control mayusculas input-sm input-cod-short" id="c_tipo_documento" readonly>
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" class="form-control input-sm text-right" id="n_documento" readonly>
                            </div>
    ...
    <div id='gridWrapper' >
        ...
        <div id='referencias_div'>
            <div class="form-group col-md-4 col-md-offset-8">
                <div class="form-group col-md-6" style='text-align:right;font-weight: bold'>Saldo Adeudado Total: $&nbsp;</div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
            ...
            if(($('#c_tipo_imponible').val() != '' && $('#d_tipo_imponible').val() != '')||(($('#c_tipo_imponible').val() == '' && $('#d_tipo_imponible').val() == ''))){
                ...
                if(($('#c_tributo').val() != '' && $('#d_tributo').val() != '')||(($('#c_tributo').val() == '' && $('#d_tributo').val() == ''))){
                        ...
                        if(($('#c_tipo_documento').val() != '' && $('#d_tipo_documento').val() != '')||(($('#c_tipo_documento').val() == '' && $('#d_tipo_documento').val() == ''))){
                            ...
                            if(!n_cuit){
                                if((c_tipo_imponible) || (c_tributo) && !(c_tipo_objeto)){
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data){
                                                ...
                                                if(ret.resultado == 'OK'){
                                                                ...
                                                                $.ajax({
                                                                    ...
                                                                    success: function(data){
                                                                        ...
                                                                        if(ret.resultado == 'OK'){
                                                                            ...
                                                                            mostrar_cuadro('E','Busqueda de Obligaciones de la Cuenta Corriente',ret.resultado,function(){$('#main').procOverlay({visible:false});}, function(){$('#main').procOverlay({visible:false});}, 400, 200);
                                                                        }
                                                                    }
                                                                });
                                                            },
                                                    ...
                                                    mostrar_cuadro('E','Búsqueda de Obligaciones de la Cuenta Corriente',ret.resultado,'', '', 400, 200);
                                                }
                                            }
                                        });
                                        $('#n_cuit').val('');
                            ...
                            mostrar_cuadro('I', 'Advertencia', 'Corrobore que los campos de descripcion esten completos. Si estan vacios es porque el codigo ingresado no tiene correspondencia con un codigo existente.', function(){$('#main').procOverlay({visible:false});},function(){$('#main').procOverlay({visible:false});}, 400, 200);
                        }
                }else{
                    mostrar_cuadro('I', 'Advertencia', 'Corrobore que los campos de descripcion esten completos. Si estan vacios es porque el codigo ingresado no tiene correspondencia con un codigo existente.', function(){$('#main').procOverlay({visible:false});}, function(){$('#main').procOverlay({visible:false});}, 400, 200);
                }
        ...
        $("#d_objeto_hecho").autocomplete({
            source: function( request, response ) {
                if(($('#c_tipo_imponible').val()!= '') && ($('#c_tributo').val()!= '')){
                    ...
                    mostrar_cuadro('I', 'Búsqueda de Objetos', 'Para buscar un Objeto/Hecho por nombre debe definir el Tipo Imponible/Tributo al que pertenece', '', '', 400, 200);
                }
            },
            minLength:0,
            select:function(event,ui){
        ...
        $("#main_grid").jqGrid({
            ...
            sortname:'d_denominacion,d_tipo_imponible,d_tributo,d_objeto_hecho',
            autowidth: false,
            height:160,
            //width: 1280,
            sortorder:'desc',
        ...
        $("#detalles_grid").jqGrid({
            ...
            ondblClickRow : function(rowid){
                ...
                post_to_url('detalle_cuenta_corr.php',{'p_f_actualizacion':p_f_actualizaicion,'p_n_id_menu':10946,'n_cuit':p_n_cuit,'id_obligacion':p_id_obligacion,'n_pos_fiscal':    p_n_pos_fiscal,'n_cuota':p_n_cuota},'_blank','POST');
            },
    ...
    function existe_contribuyente_busqueda(cuit,t_doc,n_doc){
        $.ajaxSetup({async:false});
        var result;
        $.post("cuenta_corriente/ajax_contribuyente.php",{"tipo":"existe_contribuyente","cuit":cuit,"t_doc":t_doc,"n_doc":n_doc}, function(data){
            var ret = eval('('+data+')');
