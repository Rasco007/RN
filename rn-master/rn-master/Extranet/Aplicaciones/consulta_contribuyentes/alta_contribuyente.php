<?php
	...
	$c_usuarioact=$datos_contrib[0]['C_USUARIOACT'];
	$f_actualizac=$datos_contrib[0]['F_ACTUALIZAC'];
			...
			"<form id='frm_datos_contrib'>".
				"<div id='frm_datos_contrib_div'>".
					...
					"<div class='row'>".
						...
						"</div>".
						"<div class='form-group col-md-4'>".
							"<label for='f_vig_hasta'>Fecha Vig. Hasta</label>".
							"<div class='input-group'>".
					...
					"<div class='row'>".
						...
						"</div>".
						"<div class='form-group col-md-4'>".
							"<label for='f_ult_proc_seg'>Fecha Ultimo Proc. Segmentación</label>".
					...
					"<div class='row'>".
						"<div class='form-group col-md-4'>".
							...
							"<input type='text' class='form-control input-sm text-right' name='c_usuarioact' id='c_usuarioact' value='$c_usuarioact'>".
						"</div>".
						"<div class='form-group col-md-4'>".
							"<label for='f_actualizac'>Fecha de Última Modificación</label>".
							"<input type='text' class='form-control input-sm text-right' name='f_actualizac' id='f_actualizac' value='$f_actualizac'>".
						"</div>".
						"<div class='form-group col-md-2 col-md-offset-2'>".
							"<label for='id_contrib'>ID Contrinuyente</label>".
	...
	$div_tab_per_fisica .=   	
		"<div role='tabpanel' class='tab-pane fade in form-group' id='datos_per_fisica'>".
			"<form id='frm_per_fisica'>".
				...
				"<div class='row'>".
					"<div class='form-group col-md-4'>".
						"<label for='f_actualizac'>Fecha de Útima Modificación</label>".
						"<div class='input-group'>".
	...
	$result .= $modal_cont_hist.$modal_dom_hist.$modal_tel_hist.$modal_pf_hist.$modal_pj_hist.$modal_trib_hist.$modal_act_hist.$modal_unidades_hist.$modal_est_hist;
