...
function btn_cont_hist(){
	...
	setea_parametros('#grid_datos_cont_hist',{':id_contribuyente': obtener_id_contribuyente()},'S');
...
function btn_pers_fisica_hist(){
	...
	crea_grilla_pf_hist();
	setea_parametros('#grid_datos_pf_hist',{':id_contribuyente': obtener_id_contribuyente()},'S');
...
function btn_pers_juridica_hist(){
	...
	crea_grilla_pj_hist();
	setea_parametros('#grid_datos_pj_hist',{':id_contribuyente': obtener_id_contribuyente()},'S');
...
function btn_act_hist(){
	...
	var id = $("#grid_datos_tributos").getGridParam('selrow');
    if (id) {
		datos_act_hist_grid = new GridParam({
	        id_menu: n_id_menu,
	        n_grid: 18,
	        m_autoquery: 'S',
	        param: {':id_contribuyente': obtener_id_contribuyente(),
