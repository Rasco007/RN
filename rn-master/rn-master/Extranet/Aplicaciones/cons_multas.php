...
$query = "select id_inspeccion, n_expediente ||'/'||n_anio_expediente d_expediente, n_cuit, d_denominacion
            from inspecciones inner join contribuyentes using(id_contribuyente)
            where c_estado = '5' and id_contribuyente = :id_contribuyente";
...
/*$tipoBoleta = 'MASIVA'; //tipo parametro para imprimir boleta masiva
