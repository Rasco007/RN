...
function simple_php_captcha($config = array()) {
    ...
    $simple_captcha_dir = RECURSOS_FRAMEWORK_PROY.'simple-php-captcha/';
    $image_src = $simple_captcha_dir . 'simple-php-captcha.php';
    ...
    $image_src = $image_src . '?_CAPTCHA&amp;t=' . urlencode(microtime());
