...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
	...
	*
	**/
	public function setCellCollection($pCollection){
        $this->_cellCollection = $pCollection;
    }
	
	public function getPureCellCollection(){
        return $this->_cellCollection;
    }
	...
	/**
	*
	* Nuevo metodo para que no recorra la coleccion de celdas
	*
	**/
	public function setNewCell($pCoordinate = 'A1', $pValue = null, $returnCell = false){
        $cell = $this->addCell($pCoordinate)->setValue($pValue);
        return ($returnCell) ? $cell : $this;
    }
	...
	*
	**/
	public function addCell($pCoordinate = 'A1'){
		// Uppercase coordinate
        $pCoordinate = strtoupper($pCoordinate);
