...
{
    if($variable != 'p_n_id_menu'&&$variable != 'IdSession') { // Para que no duplique el id_menu
...
<head>
    ...
    <script type="text/javascript">
        ...
        /*Seteamos colores css por si existen definidos como constantes en el pathconf.*/
        var colorPrimerNivel = '<?=COLORPRIMERNIVEL?>';
        var colorSegundoNivel = '<?=COLORSEGUNDONIVEL?>';
        var colorTercerNivel = '<?=COLORTERCERNIVEL?>';
        var colorCuartoNivel = '<?=COLORCUARTONIVEL?>';

        var r = document.querySelector(':root');

        if (colorPrimerNivel!=='COLORPRIMERNIVEL'){
            r.style.setProperty('--colorPrimerNivel', colorPrimerNivel);
        }
        if (colorSegundoNivel!=='COLORSEGUNDONIVEL'){
            r.style.setProperty('--colorSegundoNivel', colorSegundoNivel);
        }
        if (colorTercerNivel!=='COLORTERCERNIVEL'){
            r.style.setProperty('--colorTercerNivel', colorTercerNivel);
        }
        if (colorCuartoNivel!=='COLORCUARTONIVEL'){
            r.style.setProperty('--colorCuartoNivel', colorCuartoNivel);
        }
                ...
                $.ajax({
                    ...
                    success: function( info ) {
                        if(info.resultado!='OK'){
                            ...
                            document.getElementById('div_error').style.display="none";
                            document.getElementById("msj_error").innerHTML='';
                            mostrar_cuadro('A','Informacion','Se ha modificado la contraseña correctamente',
                                function(){
