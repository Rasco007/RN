...
function crea_grilla_reg_hist(){
	$("#grid_datos_reg").jqGrid({
		colNames:datos_reg_grid.colNames(),
		colModel:datos_reg_grid.colModel(),
		autowidth: false,
		height: 180,
		pager: $('#grid_datos_reg_pager'),
		caption:"Movimientos Realizados:",
		postData: datos_reg_grid.postData(),
		editurl: FUNCIONES_BASEPATH+"maestro_abm_grid.php",
		sortname:"F_VIG_DESDE",
		sortorder:"desc"
	})
	.navGrid('#grid_datos_reg_pager',{add:false, edit:false, del:false})
	.navButtonAdd('#grid_datos_reg_pager',{
		id:'btn_est_hist',
	...
	$("#grid_datos_reg_hist").jqGrid({
		...
		caption:"Movimientos Realizados Previamente:",
...
function crea_grilla_reg_historico(){
	$("#grid_datos_reg_historico").jqGrid({
		colNames:datos_reg_historico_grid.colNames(),
		colModel:datos_reg_historico_grid.colModel(),
		autowidth: false,
		height: 180,
		pager: $('#grid_datos_reg_historico_pager'),
		caption:"Movimientos Realizados Historicamente:",
		postData: datos_reg_historico_grid.postData(),
		editurl: FUNCIONES_BASEPATH+"maestro_abm_grid.php",
		sortname:"f_altaaud",
		sortorder:"desc"
	}).navGrid('#grid_datos_reg_historico_pager',{add:false, edit:false, del:false});
}
