                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-5" style="margin-top: 15px;">
                                ...
                                <button type='button' id='btn_limpiar' name='btn_limpiar' class="btn-sm btn_limpiar"></button>
                                    <button id="btn_inf_deuda" class="btn-sm" type="button">
                                        <span aria-hidden="true"></span> Informe De Deuda
                                    </button>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content col-md-12" >
                ...
                <div class="modal-body" >
                    <form id='frm_estado_deuda form-horizontal'>
                        <div class="row">
                            <div class="form-group col-md-4">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <div class="input-group" id="div_input_cuit_rep">
                                    <label >Cuit:</label>
                                    <input type="text" class="form-control input-sm "  id="n_cuit_rep"      value="" readonly=""  >
                                    <input name='id_contribuyente_rep'               id="id_contribuyente_rep" value='' type='hidden' class='sr-only'/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <div class="input-group" id="div_input_cuit_rep">
                                    ...
                                    <input type="text" class="form-control input-sm " id="denominacion_rep"  readonly="" value="">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                <label>Tributo: (*)</label>
                                <div class="input-group" id="div_input_tributo">
                                    <input type="text" class="form-control input-sm input-cod-short numerico" id="c_tributo_rep" readonly="" value="">
                                    <input type="text" class="form-control input-sm input-desc-long " id="d_tributo" value="" readonly="">
                                    <span class="input-group-addon btn_lupa" id="lupa_c_tributo">
                                        <span class="glyphicon glyphicon-search" aria-hidden="true"></span>
                                    </span>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 ">
                                ...
                                <div class="input-group" id="div_input_obj_hecho">
                                    <input type="text" class="form-control input-sm" id="objeto_rep" readonly="" value=''>
                        ...
                        <div class="row">
                                <div class="form-group col-md-6">
                                    <div class="input-group" id="div_input_pos_fiscal_desde">
                                        <label for="n_pos_fiscal_desde">Pos. Fis.-Cuota Desde:</label>
                                        <input type="text" class="form-control input-sm input-range-left" id="n_pos_desde_rep" readonly=""  placeholder="aaaa/mm" maxlength=6>
                                         <input type="text" class="form-control input-sm input-range-right" id="n_cuota_desde_rep" readonly="" placeholder="nn" maxlength=2>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="input-group" id="div_input_pos_fiscal_hasta">
                                         <label for="n_pos_fiscal_hasta">Pos. Fis.-Cuota Hasta:</label>
                                         <input type="text" class="form-control input-sm input-range-left" id="n_pos_hasta_rep" readonly="" placeholder="aaaa/mm" maxlength=6>
                                         <input type="text" class="form-control input-sm input-range-right" id="n_cuota_hasta_rep" readonly=""  placeholder="nn" maxlength=2>
                                     </div>
                                </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#btn_inf_deuda').click(function(){

            $('#c_tributo_rep').val( $('#c_tributo').val());
            $('#objeto_rep').val( $('#d_objeto_hecho').val());
            $('#n_cuit_rep').val( $('#n_cuit_mask').val());
            $('#id_contribuyente_rep').val( $('#id_contribuyente').val());
            $('#denominacion_rep').val( $('#denominacion').val());

            $('#n_pos_desde_rep').val( $('#n_pos_fiscal_desde').val());
            $('#n_pos_hasta_rep').val( $('#n_pos_fiscal_hasta').val());

            $('#n_cuota_desde_rep').val( $('#cuota_desde').val());
            $('#n_cuota_hasta_rep').val( $('#cuota_hasta').val());
        ...
        $('#btn_emitir_estado').click(function(){
            console.log('btn_emitir_estado');
            var id_contribuyente = $('#id_contribuyente_rep').val();
        ...
        $.ajax({
            ...
            data:{
                ...
                "p_c_tributo": $('#c_tributo_rep').val(),
                "p_d_objeto_hecho": $('#objeto_rep').val(),
                "p_pos_desde":fun_convierte_pos_fiscal_a_num($('#n_pos_desde_rep').val()),
                "p_pos_hasta":fun_convierte_pos_fiscal_a_num($('#n_pos_hasta_rep').val()),
                "p_cta_desde":$('#cuota_desde_rep').val(),
                "p_cta_hasta":$('#cuota_hasta_rep').val(),
                "p_tipo":$('#c_tipo').val(),
                "p_rep":'DET',
                "id_menu":10856,
                "n_orden":0
        ...
        $('#n_cuit_rep').focusout(function(){
            if ($('#n_cuit_rep').val()!= ''){
                $.ajax({
                    url: 'cuenta_corriente/devuelve_deno.php',
                    type:"POST",
                    data:{"n_cuit":limpia_cuit($("#n_cuit_rep").val())},
                    async:true,
                    success: function(data){
                        ret = eval('('+data+')');
                        if(ret != null){

                            $("#denominacion_rep").val(ret.DENOMINACION);
                            $("#id_contribuyente_rep").val(ret.ID_CONTRIBUYENTE);
                        }else{
                            $("#denominacion_rep").val(null);
                            $("#id_contribuyente_rep").val(null);
                            $("#n_cuit_rep").val(null);
        ...
        $("#main_grid").jqGrid({
            ...
            gridComplete: function() {
                ...
                if(('<?php echo $id_contribuyente; ?>' || '<?php echo $d_objeto_hecho; ?>') && $(this).jqGrid('getGridParam','records') == 0){
                    $("#btn_buscar").click();
                }
            ...
            onClickButton: function () {
                ...
                if (id){
                    ...
                    var c_tipo_imponible = $('#main_grid').getCell(id, 'c_tipo_imponible');
                    var c_tributo = $('#main_grid').getCell(id, 'c_tributo');
                    var id_contribuyente1 = $('#main_grid').getCell(id, 'id_contribuyente');



                    $('#c_tributo_rep').val( c_tributo);
                    $('#objeto_rep').val( objeto_hecho);
                    $('#n_cuit_rep').val( n_cuit);
                    $('#id_contribuyente_rep').val(id_contribuyente1 );
                    $('#denominacion_rep').val(id_contribuyente1);

                    $("#estado_deuda").modal('show');
                } else{
                    mostrar_cuadro('I', 'Advertencia', '<div>Debe seleccionar una inscripción</div>'); 
                }
            }});
