                ...
                <form id='frm_impresion_masiva'>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control input-sm text-right" name="n_secuencia_desde" id="n_secuencia_desde">
                        </div>

                        <div class="form-group col-md-6">
                            <label for="n_secuencia_hasta">Hasta</label>
                            <input type="text" class="form-control input-sm text-right" name="n_secuencia_hasta" id="n_secuencia_hasta">
                        </div>
                    </div>
                    </details>
                    ...
                    <details id="det2">
                        ...
                        <summary id="sum2">
                        Imprima por Tipo de Distribución
                            <svg class="control-icon control-icon-expand" width="24" height="24" role="presentation"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#expand-more" /></svg>
                            <svg class="control-icon control-icon-close" width="24" height="24" role="presentation"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#close" /></svg>
                        </summary>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control mayusculas input-sm input-cod-short validate[required]" id="c_distribucion">
                                    <input type="text" class="form-control input-sm input-desc-long validate[required]" id="d_distribucion" readonly>
                                    <span class="input-group-addon btn_lupa" id="lupa_c_distribucion">
