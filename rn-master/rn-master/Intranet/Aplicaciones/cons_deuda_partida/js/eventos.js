function inicializarEventos() {
    ...
    $('#n_cuit').change(function (){
        if ($('#n_cuit').val() && $('#n_cuit').val().length == 13){
            ...
            $(".filtros_contribuyente input").val(null);
            $("#d_denominacion").val(null);
            $("#n_cuit").val(null);
            $("#id_contribuyente").val(null);
            $("#n_partida, .nomen").attr('disabled',false);
            $("#n_partida, .nomen").val(null);
    ...
    $('#n_partida').change(function () {
        if (!$('#n_partida').val()){
            $(".filtros_contribuyente input, .nomen").val('');
            ...
            $.ajax({
                ...
                success: function(response)
                {
                    ...
                    if (res.resultado == 'OK'){
                        ...
                        $(".filtros_contribuyente input").val('');
                        $('.nomen').val('');
                        $('.nomen').attr('disabled',false);
                        $("#btn_lupa_regante").show();
    ...
    $('#btn_det_compensacion').click(function(){
        abrir_det_compensacion();
    });
