	    ...
	    "<div class='modal-dialog modal-lg' role='document'>".
	        "<div class='modal-content'>".
	            ...
	            "<div class='modal-body'>".
	                "<table id='grid_datos_actividades_cm$tmp' class='scroll' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr></table>".
	                "<div id='grid_datos_actividades_cm_pager$tmp' class='scroll' style='text-align:center;'></div>".
	                "<br>".
	                "<table id='grid_datos_jurisdicciones$tmp' class='scroll' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr></table>".
	                "<div id='grid_datos_jurisdicciones_pager$tmp' class='scroll' style='text-align:center;'></div>".
	            "</div>".
	...
	"<div class='modal fade' id='modal_actividades_ibd' tabindex='-1' role='dialog' aria-labelledby='actividades_ibdLabel' aria-hidden='true'>".
	    "<div class='modal-dialog modal-lg' role='document'>".
	        "<div class='modal-content'>".
	            ...
	            "</div>".
	            "<div class='modal-body'>".
	                "<table id='grid_datos_comercios$tmp' class='scroll' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr></table>".
	                "<div id='grid_datos_comercios_pager$tmp' class='scroll' style='text-align:center;'></div>".
	                "<br>".
	                "<table id='grid_datos_actividades_ibd$tmp' class='scroll' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr></table>".
	                "<div id='grid_datos_actividades_ibd_pager$tmp' class='scroll' style='text-align:center;'></div>".
	                "<br>".
	...
	"<div class='modal fade' id='modal_responsables' tabindex='-1' role='dialog' aria-labelledby='responsablesLabel' aria-hidden='true'>".
	    "<div class='modal-dialog modal-lg' role='document'>".
	        "<div class='modal-content'>".
	            ...
	            "</div>".
	            "<div class='modal-body'>".
	                "<table id='grid_datos_responsables_trib$tmp' class='scroll' cellpadding='0' cellspacing='0'><tr><td>&nbsp;</td></tr></table>".
	                "<div id='grid_datos_responsables_trib_pager$tmp' class='scroll' style='text-align:center;'></div>".
	            "</div>".
	            "<div class='modal-footer'>".
	                "<div class='text-center'>".
