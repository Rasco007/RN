...
if ($oper === 'getValoresMulta'){
    ...
    $db_query = new DB_Query("
            SELECT n_dias_vto, c_tipo_dias, i_monto_fijo, i_monto_fijo_desde, 
            i_monto_fijo_hasta, m_automatica, p_descuento_vto,P_DESCUENTO_NOTIF 
...
if ($oper === 'controlarFechaEmision'){
    ...
    $db_query = new DB_Query("
    select web.FUN_CONTROLAR_FECHA(:filtro,60) resultado FROM DUAL");
