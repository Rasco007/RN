...
if ($oper === 'getTributoHecho'){
    $db_query = new DB_Query("
        select ct.c_tipo_imponible, ct.c_tributo, ct.d_objeto_hecho
        from contribuyentes_tributos ct, siat.tablas_generales tg, tributos t, contribuyentes c
        where ct.n_tabla_tipo_imp = tg.n_tabla 
        and ct.c_tipo_imponible = tg.c_dato  
        and ct.c_tipo_imponible = t.c_tipo_imponible 
