function inicializarEventos() {
    ...
    $('#btn_imp_const').click(function() {
        ...
        if (id) {
            ...
            if (c_mot == 88) {
                llamar_report('EXENL_006_88', 'p_id_exencion|' + $('#excepciones_grid').getCell(id, 'id_excepcion'), 'PDF');
            }else if (c_mot == 87){
                    ...
                    success: function(response)
                    {
                        ...
                        if (res){
                            if (parse(res['CONTADOR']) > 0) {
                                ...
                                llamar_report('EXENL_006_87', 'p_id_exencion|' + $('#excepciones_grid').getCell(id, 'id_excepcion'), 'PDF');
                            }
                        }else{
                            $('#n_cuit').val(null);
                            $("#d_denominacion").val(null);
                ...
                llamar_report('EXENL_006', 'p_id_exencion|' + $('#excepciones_grid').getCell(id, 'id_excepcion'), 'PDF');
            }
        }else {
