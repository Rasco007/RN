<?php
    ...
    if($oper == 'tributo_objeto_fechas_regimen'){
        $id_contribuyente = ($_REQUEST['p_id_contribuyente']);
        $procedure = "PAC_IIBB_CM.autocompleta_con_id_contrib(:p_id_contribuyente)";
    ...
    if($oper == 'tributo_y_objeto'){
        ...
        $procedure = "PAC_IIBB_CM.autocompl_por_tributo_y_obj(:p_c_tributo,:p_d_obj_hecho)";
