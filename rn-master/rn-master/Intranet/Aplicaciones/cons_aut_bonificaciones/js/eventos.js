function inicializarEventos() {
    ...
    $("#d_denominacion").autocomplete({
        source: function( request, response ) {
            ...
            ajax_autocomplete =
                $.ajax({
                    type:'POST',
                    url: "cons_aut_bonificaciones/php/autocomplete.php",
    ...
    $('#btn_buscar').click(function () {
        ...
        if (!$('#id_contribuyente').val() && !$('#d_objeto_hecho').val()){
            mostrar_cuadro('V', 'Atención', 'Nro de cuit o (tipo y nro. de Documento) o (Tributo y Nro. de Inscripción) para realizar la busqueda.',null,null,400);
            return;
        }
