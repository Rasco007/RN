function init_grillas(){
    ...
    $("#grid_instancias").jqGrid({
        ...
        onSelectRow: function(id) {
            var f_confirmacion = $('#grid_instancias').getCell(id,'f_confirmacion');
            ...
            setea_parametros('#main_grid',{
                ...
                ':p_c_tributo': $('#grid_instancias').getCell(id,'c_tributo'),
                ':p_d_objeto_hecho': $('#grid_instancias').getCell(id,'d_objeto_hecho')
            });
            $('#btn_revertir_juicio').attr('disabled',false);
        }
