<?php
    ...
    if($oper == 'cuit'){
        ...
        $procedure = "PAC_INGRESO_PAGOS.autocomplete_por_cuit(:p_filtro)";
    ...
    if($oper == 'tributo_y_objeto'){
        ...
        $procedure = "PAC_INGRESO_PAGOS.autocompl_por_tributo_y_obj(:p_c_tributo,:p_d_obj_hecho)";
    ...
    if($oper == 'doc'){
        ...
        $procedure = "PAC_INGRESO_PAGOS.autocomplete_por_doc(:p_c_documento, :p_documento)";
