...
include('workflow_em/html/principal.html');
?>
    <script type='text/javascript' src='workflow_general/js/grillas.js?no_cache=<?=date('dmyhis')?>'></script>
    <script type='text/javascript' src='workflow_em/js/eventos.js?no_cache=<?=date('dmyhis')?>'></script>
    <script type='text/javascript' src='workflow_em/js/funciones.js?no_cache=<?=date('dmyhis')?>'></script>
    ...
    <script>
        ...
        $(document).ready(function() {
            inicializarGrillas(deshabilitarBotonesFinalizacion);
            inicializarEventos();
            inicializarFiltro();
        });
    </script>
