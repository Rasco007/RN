...
#HTML PRINCIPAL
include('aut_bonificaciones/html/principal.html');
include('aut_bonificaciones/html/modals.html');
?>
    <style>
        .formError {
            z-index: 15000;
    ...
    <script type='text/javascript' src='aut_bonificaciones/js/grillas.js'></script>
    <script type='text/javascript' src='aut_bonificaciones/js/eventos.js'></script>
    <script type='text/javascript' src='aut_bonificaciones/js/funciones.js'></script>
