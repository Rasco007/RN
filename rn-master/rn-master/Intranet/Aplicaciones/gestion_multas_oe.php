...
$sql = "select web.FUN_BUSCAR_HABIL(trunc(sysdate) + 60) fecha_max from dual";

$db_query = new DB_Query($sql);
$results = $db_query->do_query($param);
$fecha_max_emision = $results[0]['FECHA_MAX'];
#HTML PRINCIPAL
include('gestion_multas_oe/html/principal.php');
